...
const en = {
  ...
  "auth.displayNameHint": "Shown only inside your personal library.",
  ...
  "auth.errAcceptTerms": "Accept the Terms and Privacy Notice to create your account.",
  "auth.errDisplayName": "Use a display name between 2 and 40 characters.",
  "auth.errGeneric": "Something went wrong. Please try again.",
  "auth.agreePrefix": "I agree to the",
  "auth.agreeAnd": "and",
  "auth.legalNotice": "By using EBARA, you agree to our {terms} and acknowledge our {privacy}.",
  ...
  "header.accountName": "Account display name",
  "header.guestInitial": "G",
  "header.previewInitial": "P",
  ...
  "add.hint":
    "Type an English word, expression, or short sentence. We’ll prepare the useful details.",
  "add.placeholder": "Type a word, expression, or short sentence",
  "add.inputLabel": "English word, expression, or short sentence",
  "add.voice": "Add word by voice",
  "add.stopVoice": "Stop listening",
  "add.requestingMic": "Getting the microphone ready…",
  "add.listening": "Listening… say a word, expression, or short sentence",
  "add.processingVoice": "Turning your voice into text…",
  "add.didYouMean": "Did you mean?",
  "add.recommended": "Recommended",
  "add.lookup": "Prepare it",
  "add.lookingUp": "Preparing…",
  "add.save": "Save to my box",
  "add.saveSentence": "Save the whole sentence",
  "add.sentenceSuggestionTitle": "Want to save a word from this sentence?",
  "add.sentenceSuggestionHint":
    "Choose the word you learned. We’ll keep this sentence as its example.",
  "add.saving": "Saving…",
  "add.tryAnother": "Try another",
  "add.close": "Close add word",
  "add.errOneWord": "Enter one English word, expression, or short sentence.",
  ...
  "add.errVoiceNoMicrophone":
    "We couldn’t access a working microphone. Check your device input and try again.",
  "add.errVoiceNoSpeech": "We didn’t hear any speech. Try again and speak after the mic starts.",
  "add.errVoiceUnclear": "I couldn’t hear that clearly. Try once more or type the word.",
  "add.errVoiceNetwork": "Voice recognition couldn’t connect. Check your connection and try again.",
  "add.errVoiceService": "Voice recognition is temporarily unavailable. Try again in a moment.",
  "add.errVoiceLanguage": "English voice recognition isn’t available on this device.",
  "add.errVoiceRateLimited": "The voice service is busy. Wait a moment and try again.",
  "add.errVoiceStart": "The microphone couldn’t start. Close other audio apps and try again.",
  ...
  "settings.displayNameHint": "This is how EBARA greets you. It is not public.",
  "settings.saveDisplayName": "Save name",
  "settings.displayNameSaved": "Name saved",
  "settings.displayNameError": "Use a display name between 2 and 40 characters.",
  ...
  "settings.exportHint": "Save a JSON copy of your vocabulary on this device.",
  "settings.clearGuest": "Clear guest library",
  "settings.clearGuestConfirm": "Clear every guest word saved on this device? This cannot be undone.",
  "settings.deleteAccount": "Delete account",
  "settings.deleteAccountHint": "Permanently removes your account and every saved word.",
  "settings.deleteConfirmTitle": "Delete your account?",
  "settings.deleteConfirmBody": "Your account, words, and notes will be permanently removed. This cannot be undone.",
  "settings.cancel": "Cancel",
  "settings.deleteForever": "Delete forever",
  "settings.actionError": "We couldn't complete that request. Please try again.",
...
const ar: Dictionary = {
  ...
  "auth.emailPlaceholder": "you@example.com",
  "auth.displayName": "وش تحب نناديك؟",
  "auth.displayNamePlaceholder": "مثال: ابو عامر",
  "auth.displayNameHint": "يظهر لك داخل مكتبتك الشخصية فقط.",
  ...
  "auth.errAcceptTerms": "وافق على الشروط وإشعار الخصوصية عشان تنشئ حسابك.",
  "auth.errDisplayName": "اكتب اسم عرض من حرفين إلى ٤٠ حرفًا.",
  "auth.errGeneric": "صار خطأ. جرّب مرة ثانية.",
  "auth.agreePrefix": "أوافق على",
  "auth.agreeAnd": "و",
  "auth.legalNotice": "باستخدامك EBARA، أنت توافق على {terms} وتقر باطلاعك على {privacy}.",
  ...
  "header.accountName": "اسم الحساب",
  "header.guestInitial": "ز",
  "header.previewInitial": "م",
  ...
  "add.hint": "اكتب كلمة أو تعبير أو جملة إنجليزية قصيرة، وبنجهز لك المعلومات المفيدة.",
  "add.placeholder": "اكتب كلمة أو تعبير أو جملة قصيرة",
  "add.inputLabel": "كلمة أو تعبير أو جملة إنجليزية قصيرة",
  "add.voice": "أضف كلمة بصوتك",
  "add.stopVoice": "إيقاف الاستماع",
  "add.requestingMic": "نجهّز المايك…",
  "add.listening": "نسمعك… قل كلمة أو تعبير أو جملة قصيرة",
  "add.processingVoice": "نحوّل صوتك إلى نص…",
  "add.didYouMean": "تقصد؟",
  "add.recommended": "الأقرب",
  "add.lookup": "جهّزها",
  "add.lookingUp": "نجهزها…",
  "add.save": "احفظها بمكتبتي",
  "add.saveSentence": "احفظ الجملة كاملة",
  "add.sentenceSuggestionTitle": "تبي تحفظ كلمة من الجملة؟",
  "add.sentenceSuggestionHint": "اختر الكلمة اللي تعلمتها، وبنحفظ الجملة كمثال لها.",
  "add.saving": "نحفظ…",
  "add.tryAnother": "جرّب كلمة ثانية",
  "add.close": "إغلاق",
  "add.errOneWord": "اكتب كلمة أو تعبير أو جملة إنجليزية قصيرة.",
  ...
  "add.errVoiceNoMicrophone": "ما قدرنا نوصل لمايك شغال. تأكد من جهاز الإدخال وجرّب مرة ثانية.",
  "add.errVoiceNoSpeech": "ما سمعنا كلام. انتظر لين يشتغل المايك ثم قل الكلمة.",
  "add.errVoiceUnclear": "ما سمعناها زين. جرّب مرة ثانية أو اكتبها.",
  "add.errVoiceNetwork": "التعرّف على الصوت ما قدر يتصل. تأكد من الإنترنت وجرّب مرة ثانية.",
  "add.errVoiceService": "خدمة التعرّف على الصوت متوقفة مؤقتًا. جرّب بعد لحظات.",
  "add.errVoiceLanguage": "التعرّف على الصوت الإنجليزي غير متاح على هذا الجهاز.",
  "add.errVoiceRateLimited": "خدمة الصوت مشغولة الآن. انتظر شوي وجرّب مرة ثانية.",
  "add.errVoiceStart": "المايك ما قدر يبدأ. اقفل تطبيقات الصوت الثانية وجرّب مرة ثانية.",
  ...
  "settings.displayName": "وش تحب نناديك؟",
  "settings.displayNamePlaceholder": "مثال: ابو عامر",
  "settings.displayNameHint": "هذا الاسم اللي تستقبلك فيه EBARA، وما يظهر للعامة.",
  "settings.saveDisplayName": "احفظ الاسم",
  "settings.displayNameSaved": "تم حفظ الاسم",
  "settings.displayNameError": "اكتب اسم عرض من حرفين إلى ٤٠ حرفًا.",
  ...
  "settings.export": "نزّل بياناتي",
  "settings.exportHint": "احفظ نسخة JSON من مكتبتك على هذا الجهاز.",
  "settings.clearGuest": "امسح مكتبة الزائر",
  "settings.clearGuestConfirm": "تمسح كل كلمات الزائر المحفوظة بهذا الجهاز؟ ما تقدر تتراجع بعد المسح.",
  "settings.deleteAccount": "حذف الحساب",
  "settings.deleteAccountHint": "يحذف حسابك وكل كلماتك بشكل نهائي.",
  "settings.deleteConfirmTitle": "متأكد تبي تحذف حسابك؟",
  "settings.deleteConfirmBody": "بينحذف حسابك وكل الكلمات والملاحظات نهائياً. ما تقدر تتراجع بعد الحذف.",
  "settings.cancel": "إلغاء",
  "settings.deleteForever": "احذف نهائياً",
  "settings.actionError": "ما قدرنا ننفذ الطلب. جرّب مرة ثانية.",
