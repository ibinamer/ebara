 ...
 * in Supabase; this table only protects the Google translation budget.
 */
export const GOOGLE_TRANSLATION_USAGE_TABLE_SQL = `CREATE TABLE IF NOT EXISTS google_translation_usage (
